...
public class WeatherServlet extends HttpServlet {
  ...
  private String configureEnvDiscovery() {
    // Use environment variables for server discovery in containerized environments
    String serverEnv = System.getenv("SERVER_NAME");
    if (serverEnv == null || serverEnv.isEmpty()) {
      serverEnv = "default-server";
    }
    return serverEnv;
  }

  // Removed WebSphere-specific RMI/IIOP InitialContext configuration
  // In containerized environments, use REST/HTTP-based service discovery
