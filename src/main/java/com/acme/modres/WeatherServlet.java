...
public class WeatherServlet extends HttpServlet {
  ...
  // Use ${SERVER_NAME} and ${SERVER_DISPLAY_NAME} environment variables instead
  
  // Removed WebSphere-specific RMI/IIOP InitialContext configuration
  // For containerized deployments, use REST/HTTP-based service discovery
  // with environment variables like ${SERVICE_DISCOVERY_URL}
}
